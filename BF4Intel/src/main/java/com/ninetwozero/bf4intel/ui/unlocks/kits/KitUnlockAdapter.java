...
public class KitUnlockAdapter extends BaseUnlockAdapter<WeaponUnlock> {
    public KitUnlockAdapter(final Map<String, List<WeaponUnlock>> itemMap, final Context context) {
